...
namespace XPXR.Recorder
{
    public class DataManager
    {
        ...
        public string GetUserId()
        {
            ...
            {
                throw new XPXRException("Cannot get the User Id, there is no current user, please start a session which create a new user.");
            }
        }
        ...
        public string GetEnvironnementId()
        {
            ...
            {
                throw new XPXRException("Cannot get the Environnement Id, there is no started Session.");
            }
        }
        ...
        public void AddEnvironmentProperties(Dictionary<string,string> properties)
        {
            ...
            {
                throw new XPXRException("Cannot add Environnement properties, there is no started Session.");
            } 
        }
        ...
        public void AddInternalEvent(SystemType systemType, string systemName, string property, Jsonable value)
        {
            ...
            if (!this._currentSessions.TryPeek(out session))
            {
                throw new XPXRException("Cannot add an InternalEvent, there is no started Session.");
            }
